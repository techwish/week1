...
#snarkjs groth16 setup Multiplier3-plonk/Multiplier3.r1cs powersOfTau28_hez_final_10.ptau Multiplier3-plonk/circuit_0000.zkey
...
snarkjs zkey export solidityverifier Multiplier3-plonk/circuit_final.zkey ../Multiplier3pVerifier.sol
